...
class FrontSideBarMenu extends React.Component{
    ...
    render(){
        return(
            <>
            <Nav.Link className="py-0 pl-5" href="javascript:void(0)" onClick={(e) => this.ChatSwitchToggle(e)} style={{lineHeight:'0px'}}>
            ...
            <div className={this.state.isChatUserActive ? "side_menu" : "side_menu open_side_menu"}>
                <Nav.Link className="close_menu" href="javascript:void(0)" onClick={(e) => this.ChatSwitchToggle(e)}>
