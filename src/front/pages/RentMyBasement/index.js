...
function RentMyBasementComponentCtrl() {
                                ...
                                <Col sm={8}>
                                    <div className="my-5">
                                        <h2 className="clr_bg_stash_hdng">
                                            <span> Earn Money </span> Renting Out Your Basement
                                        </h2>
                            ...
                            <Row className="justify-content-center">
                                <Col sm={8}>
                                    <div className="clr_bg_stash_form_card">
                                        <StepOneForm spaceTypeId={7} disableSpaceControl={true} />
                                    </div>
                                </Col>
                            </Row>
                        </Col>
...
export default RentMyBasementComponentCtrl;