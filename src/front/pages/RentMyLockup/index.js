...
function RentMyLockupComponentCtrl() {
                                ...
                                <Col sm={8}>
                                    <div className="my-5">
                                        <h2 className="clr_bg_stash_hdng">
                                            <span> Earn Money </span> Renting Out Your Lockup
                                        </h2>
                            ...
                            <Row className="justify-content-center">
                                <Col sm={8}>
                                    <div className="clr_bg_stash_form_card">
                                        <StepOneForm spaceTypeId={4} disableSpaceControl={true} />
                                    </div>
                                </Col>
                            </Row>
                        </Col>
...
export default RentMyLockupComponentCtrl;