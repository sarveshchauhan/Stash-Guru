                        ...
                        <div className="">
                            <div className="row">
                                <div className="col-sm-4">
                                    <button onClick={() => history.push('/')} className="btn m-1 btn-success btn-block"> <i className="fa fa-home"></i> Back To Home</button>
                                </div>
                                <div className="col-sm-4">
                                    <button onClick={() => history.push('/')} className="btn m-1 btn-success btn-block"><i className="fa fa-search" aria-hidden="true"></i> Search Places</button>
                                </div>
                                <div className="col-sm-4">
                                    <button onClick={() => history.push('/list-your-space')} className="btn m-1 btn-success btn-block"><i className="fa fa-map-marker" aria-hidden="true"></i> List Your Space</button>
                                </div>
                            </div>
                        </div>
                    </div>
