...
const reducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case LISTING_COUNT_REQUEST:
            return {
                ...state,
                listingCountLoading: true
            }

        case LISTING_COUNT_SUCCESS:
            return {
                ...state,
                listingCountLoading: false,
        ...
        case LISTING_COUNT_FAILURE:
            return {
                ...state,
                listingCountLoading: false,
                listingCountError: action.payload
            }
