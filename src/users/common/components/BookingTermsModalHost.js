...
import { termsSignIn, termsSignInHost, toggleBookingTermsModal, toggleBookingTermsModalHost } from '../../../redux';
import './bookingComp.css';

function BookingTermsModalHost() {

    const { signInHostLoading, signInHostError } = useSelector(state => state.booking);
